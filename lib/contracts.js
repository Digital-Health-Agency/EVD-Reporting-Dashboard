 ...
 * @property {Array<{name:string, screened:number, uniqueTravelers:number, unknown:boolean}>} byPoe
 ...
 * @property {"live"|"pending"|"na"} source  live = real; pending = awaiting mart; na = not applicable for this disease.
