...
//
// `tokens` are the raw, messy values seen in warehouse fields such as
// test_name/component_name. The backend owns SQL normalization; the dashboard
// keeps this registry for UI routing and labels only.
